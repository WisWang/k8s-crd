...
type FakeNetworks struct {
	Fake *FakeSmaplecrdV1
	ns   string
}

var networksResource = schema.GroupVersionResource{Group: "smaplecrd.k8s.io", Version: "v1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "smaplecrd.k8s.io", Version: "v1", Kind: "Network"}
