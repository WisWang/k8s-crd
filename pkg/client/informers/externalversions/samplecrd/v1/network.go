...
import (
	...
	internalinterfaces "k8s-crd/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-crd/pkg/client/listers/samplecrd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SmaplecrdV1().Networks(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SmaplecrdV1().Networks(namespace).Watch(options)
			},
		},
		&samplecrdv1.Network{},
		resyncPeriod,
